...
img_output="deepexi/aa"      # output image tag
...
sudo mv $proj_home/aa-provider/target/aa-*.jar $proj_home/aa-provider/target/demo.jar # 兼容所有sh脚本
